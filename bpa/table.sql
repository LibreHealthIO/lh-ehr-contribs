CREATE TABLE IF NOT EXISTS form_bpa (
  ...
  `reason_seeking` longtext COLLATE utf8_unicode_ci NOT NULL,
  `presenting_problem` longtext COLLATE utf8_unicode_ci NOT NULL,
  `personal_family_history` longtext COLLATE utf8_unicode_ci,
  ...
  `affect_euthymic` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  `affect_dysthymic` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `mood_irritated` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mood_anxious` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `mood_appropriate_to_topic` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mood_inappropriate_to_topic` varchar(3) COLLATE utf8_unicode_ci DEFAULT NULL,
