...
$obj = formFetch("form_bpa", $_GET["id"]);

?>
<form method=post action="<?echo $rootdir?>/forms/bpa/save.php?mode=update&id=<?echo $_GET["id"];?>" name="my_form">
<span class="title"><center><b>Counseling Assessment</b></center></span><br><br>
<center>
<? if($obj{"finalize"}!="on"){?>
...
<textarea cols=120 rows=2 wrap=virtual name="reason_seeking"><? echo stripslashes($obj{"reason_seeking"}); ?></textarea><br /><br />
...
<textarea cols=120 rows=2 wrap=virtual name="personal_family_history"><? echo stripslashes($obj{"personal_family_history"}); ?></textarea><br /><br />

<b><u>Mental Status</u></b>
<br><br>
<b>Appearance:</b><br>
<input type=checkbox name='appearance_age' <? if ($obj{"appearance_age"} == "on") {echo "checked";};?>>&nbsp;<b>Stated Age</b><br>
<input type=checkbox name='appearance_younger'<? if ($obj{"appearance_younger"} == "on") {echo "checked";};?>>&nbsp;<b>Younger than Stated Age</b><br>
<input type=checkbox name='appearance_older'<? if ($obj{"appearance_older"} == "on") {echo "checked";};?>>&nbsp;<b>Older than Stated Age</b><br>
<input type=checkbox name='appearance_underweight'<? if ($obj{"appearance_underweight"} == "on") {echo "checked";};?>>&nbsp;<b>Underweight</b><br>
<input type=checkbox name='appearance_petite'<? if ($obj{"appearance_petite"} == "on") {echo "checked";};?>>&nbsp;<b>Petite</b><br>
<input type=checkbox name='appearance_average'<? if ($obj{"appearance_average"} == "on") {echo "checked";};?>>&nbsp;<b>Average Size</b><br>
<input type=checkbox name='appearance_overweight'<? if ($obj{"appearance_overweight"} == "on") {echo "checked";};?>>&nbsp;<b>Overweight</b><br><br>

<b>Coordination/Gait:</b><br>
<input type=checkbox name='coordination_good'<? if ($obj{"coordination_good"} == "on") {echo "checked";};?>>&nbsp;<b>No Difficulty</b><br>
<input type=checkbox name='coordination_staggered'<? if ($obj{"coordination_staggered"} == "on") {echo "checked";};?>>&nbsp;<b>Staggered</b><br>
<input type=checkbox name='coordination_shuffled'<? if ($obj{"coordination_shuffled"} == "on") {echo "checked";};?>>&nbsp;<b>Shuffled</b><br>
<input type=checkbox name='coordination_clumsy'<? if ($obj{"coordination_clumsy"} == "on") {echo "checked";};?>>&nbsp;<b>Clumsy</b><br><br>

<b>Eye Contact:</b><br>
<input type=checkbox name='eye_good' <? if ($obj{"eye_good"} == "on") {echo "checked";};?>>&nbsp;<b>Good</b><br>
<input type=checkbox name='eye_brief' <? if ($obj{"eye_brief"} == "on") {echo "checked";};?>>&nbsp;<b>Brief/Fleeting</b><br>
<input type=checkbox name='eye_avoid' <? if ($obj{"eye_avoid"} == "on") {echo "checked";};?>>&nbsp;<b>Avoided</b><br><br>

<b>Affect (Observed):</b><br>
<input type=checkbox name='affect_normal' <? if ($obj{"affect_normal"} == "on") {echo "checked";};?>>&nbsp;<b>Normal/appropriate</b><br>
<input type=checkbox name='affect_euthymic' <? if ($obj{"affect_euthymic"} == "on") {echo "checked";};?>>&nbsp;<b>Euthymic</b><br>
<input type=checkbox name='affect_dysthymic' <? if ($obj{"affect_dysthymic"} == "on") {echo "checked";};?>>&nbsp;<b>Dysthymic</b><br>
<input type=checkbox name='affect_flat' <? if ($obj{"affect_flat"} == "on") {echo "checked";};?>>&nbsp;<b>Flat</b><br>
<input type=checkbox name='affect_labile' <? if ($obj{"affect_labile"} == "on") {echo "checked";};?>>&nbsp;<b>Vacilating/Labile</b><br>
...
<input type=checkbox name='mood_calm' <? if ($obj{"mood_calm"} == "on") {echo "checked";};?>>&nbsp;<b>Calm</b><br>
<input type=checkbox name='mood_happy' <? if ($obj{"mood_happy"} == "on") {echo "checked";};?>>&nbsp;<b>Happy</b><br>
<input type=checkbox name='mood_irritated' <? if ($obj{"mood_irritated"} == "on") {echo "checked";};?>>&nbsp;<b>Irritated</b><br>
<input type=checkbox name='mood_anxious' <? if ($obj{"mood_anxious"} == "on") {echo "checked";};?>>&nbsp;<b>Anxious</b><br>
<input type=checkbox name='mood_sad' <? if ($obj{"mood_sad"} == "on") {echo "checked";};?>>&nbsp;<b>Sad</b><br>
<input type=checkbox name='mood_angry' <? if ($obj{"mood_angry"} == "on") {echo "checked";};?>>&nbsp;<b>Angry</b><br>
<input type=checkbox name='mood_excited' <? if ($obj{"mood_excited"} == "on") {echo "checked";};?>>&nbsp;<b>Excited</b><br>
<input type=checkbox name='mood_appropriate_to_topic' <? if ($obj{"mood_appropriate_to_topic"} == "on") {echo "checked";};?>>&nbsp;<b>Appropriate to Topic of Conversation</b><br>
<input type=checkbox name='mood_inappropriate_to_topic' <? if ($obj{"mood_inappropriate_to_topic"} == "on") {echo "checked";};?>>&nbsp;<b>Inappropriate to Topic of Conversation</b><br>
<br><br>

<b>Speech/Stream of Thought:</b><br>
<input type=checkbox name='speech_clear' <? if ($obj{"speech_clear"} == "on") {echo "checked";};?>>&nbsp;<b>Clear</b><br>
<input type=checkbox name='speech_articulate' <? if ($obj{"speech_articulate"} == "on") {echo "checked";};?>>&nbsp;<b>Articulate</b><br>
<input type=checkbox name='speech_unclear' <? if ($obj{"speech_unclear"} == "on") {echo "checked";};?>>&nbsp;<b>Unclear</b><br>
<input type=checkbox name='speech_slow' <? if ($obj{"speech_slow"} == "on") {echo "checked";};?>>&nbsp;<b>Slow</b><br>
<input type=checkbox name='speech_soft' <? if ($obj{"speech_soft"} == "on") {echo "checked";};?>>&nbsp;<b>Soft Spoken</b><br>
<input type=checkbox name='speech_mumble' <? if ($obj{"speech_soft"} == "on") {echo "checked";};?>>&nbsp;<b>Mumbled</b><br>
<input type=checkbox name='speech_excessive' <? if ($obj{"speech_excessive"} == "on") {echo "checked";};?>>&nbsp;<b>Excessive/Rapid</b><br>
<input type=checkbox name='speech_negative' <? if ($obj{"speech_negative"} == "on") {echo "checked";};?>>&nbsp;<b>Negative/Critical</b><br><br>
...
<b>Risk Factors:</b><br>
<input type=checkbox name='risk_compliance' <? if ($obj{"risk_compliance"} == "on") {echo "checked";};?>>&nbsp;<b>Hx of Tx Non-Compliance</b><br>
<input type=checkbox name='risk_elope' <? if ($obj{"risk_elope"} == "on") {echo "checked";};?>>&nbsp;<b>Hx/Px of Elopement</b><br>
<input type=checkbox name='risk_multi' <? if ($obj{"risk_multi"} == "on") {echo "checked";};?>>&nbsp;<b>Hx of Multiple Dx</b><br>
<input type=checkbox name='risk_inpatient' <? if ($obj{"risk_inpatient"} == "on") {echo "checked";};?>>&nbsp;<b>Prior Inpatient Treatment</b><br>
<input type=checkbox name='risk_hxsuicide' <? if ($obj{"risk_hxsuicide"} == "on") {echo "checked";};?>>&nbsp;<b>Prior Homicide or Suicide Attempt</b><br>
<input type=checkbox name='risk_injury' <? if ($obj{"risk_injury"} == "on") {echo "checked";};?>>&nbsp;<b>Self Injurious</b><br>
<input type=checkbox name='risk_suicide' <? if ($obj{"risk_suicide"} == "on") {echo "checked";};?>>&nbsp;<b>Current Suicide Ideation</b><br>
<input type=checkbox name='risk_self' <? if ($obj{"risk_self"} == "on") {echo "checked";};?>>&nbsp;<b>Imminent Risk of Harm to Self</b><br>
<input type=checkbox name='risk_threat' <? if ($obj{"risk_threat"} == "on") {echo "checked";};?>>&nbsp;<b>Threats to Harm Others</b><br>
<input type=checkbox name='risk_aggression' <? if ($obj{"risk_aggression"} == "on") {echo "checked";};?>>&nbsp;<b>Aggression</b><br>
<input type=checkbox name='risk_homicide_ideation' <? if ($obj{"risk_homicide_ideation"} == "on") {echo "checked";};?>>&nbsp;<b>Current Homicidal Ideation</b><br>
<input type=checkbox name='risk_harm' <? if ($obj{"risk_harm"} == "on") {echo "checked";};?>>&nbsp;<b>Imminent Risk of Harm to Others</b><br>
<input type=checkbox name='risk_other' <? if ($obj{"risk_other"} == "on") {echo "checked";};?>>&nbsp;<b>Other Risk Factors Noted</b><br><br>
