...
$encounter = date("Ymd");
if ($_GET["mode"] == "new"){
$newid = formSubmit("form_bpa", $_POST, $_GET["id"], $userauthorized);

addForm($encounter, "Bio Psycho-Social Assessment", $newid, "bpa", $pid, $userauthorized);
}elseif ($_GET["mode"] == "update") {
sqlInsert("update form_bpa set pid = {$_SESSION["pid"]},groupname='".$_SESSION["authProvider"]."',user='".$_SESSION["authUser"]."',authorized=$userauthorized,activity=1, date = NOW(),
reason_seeking ='".$_POST["reason_seeking"]."', 
presenting_problem ='".$_POST["presenting_problem"]."', 
personal_family_history ='".$_POST["personal_family_history"]."', 
...
affect_euthymic ='".$_POST["affect_euthymic"]."',
affect_dysthymic ='".$_POST["affect_dysthymic"]."',
...
mood_irritated ='".$_POST["mood_irritated"]."',
mood_anxious ='".$_POST["mood_anxious"]."',
mood_sad ='".$_POST["mood_sad"]."',
mood_angry ='".$_POST["mood_angry"]."',
mood_excited ='".$_POST["mood_excited"]."',
mood_appropriate_to_topic ='".$_POST["mood_appropriate_to_topic"]."',
mood_inappropriate_to_topic ='".$_POST["mood_inappropriate_to_topic"]."',
