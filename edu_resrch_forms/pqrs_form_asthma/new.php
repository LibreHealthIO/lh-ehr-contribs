...
<font size=2>
<form method=post action="<?php echo $rootdir;?>/forms/pqrs_form_asthma/save.php?mode=new" name="my_form">
<br>
<span class="title"><center>Asthma Quality Reporting</center></span><br><br>
...
<textarea cols=120 rows=3 wrap=virtual name="purpose" >To ensure quality care and reporting on patients with Asthma.</textarea>
<br><br>
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0053 <a target="_blank" href="#" title="(NQF #0047)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- Asthma: Pharmacologic Therapy for Persistent Asthma - Ambulatory Care Setting <a target="_blank" href="#" title="National Quality Strategy Domain: Effective Clinical Care"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient with persistent asthma prescribed long-term asthma control medication? 
	<p></b>


	<input type="radio" name="Asthma0053" value="1038F 4140F">Inhaled corticosteroids prescribed. 
	...
	<input type="radio" name="Asthma0053" value="4144F">Alternative long-term control medication prescribed. 
	...
	<input type="radio" name="Asthma0053" value="4140F:2P 1038F">Documentation of patient reason(s) for not prescribing medication. 
	...
	<input type="radio" name="Asthma0053" value="1039F">Intermittent asthma. 
	...
	<input type="radio" name="Asthma0053" value="4140F:8P 1038F">Medication not prescribed, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Asthma0110" value="G8482">Influenza immunization administered or previously received. 
	...
	<input type="radio" name="Asthma0110" value="G8483">Influenza immunization not administered, reason documented. 
	...
	<input type="radio" name="Asthma0110" value="G8484">Influenza immunization was not administered, reason not given. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Asthma0128" value="G8420">BMI is documented within normal parameters and no follow-up plan is required. 
	...
	<input type="radio" name="Asthma0128" value="G8417">BMI is documented above normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="Asthma0128" value="G8418">BMI is documented below normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="Asthma0128" value="G8421">BMI not documented and no reason is given. 
	...
	<input type="radio" name="Asthma0128" value="G8419">BMI documented outside normal parameters, no follow-up plan documented, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Asthma0130" value="G8427">Current (or no) medications documented in the patient's medical record. 
	...
	<input type="radio" name="Asthma0130" value="G8430">Patient is not eligible. 
	...
	<input type="radio" name="Asthma0130" value="G8428">Current list of medications not documented, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Asthma0226" value="4004F">Patient screened for tobacco use AND received tobacco cessation intervention if identified as a tobacco user. 
	...
	<input type="radio" name="Asthma0226" value="1036F">Current tobacco non-user. 
	...
	<input type="radio" name="Asthma0226" value="4004F:1P">Documentation of medical reason(s) for not screening for tobacco use. 
	...
	<input type="radio" name="Asthma0226" value="4004F:8P">Tobacco screening OR tobacco cessation intervention not performed, NOS. 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0402 <a target="_blank" href="#" title="(NQF #0000)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- Tobacco Use and Help with Quitting Among Adolescents <a target="_blank" href="#" title="National Quality Strategy Domain: Community / Population Health"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient screened for tobacco use within 18 months? <a target="_blank" href="#" title="Screened during the measurement period or the six months prior to the measurement period AND received tobacco cessation counseling intervention if identified as a tobacco user."><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	<p></b>


	<input type="radio" name="Asthma0402" value="G9458">Patient documented as tobacco user AND received tobacco cessation intervention if identified as a tobacco user. 
	...
	<input type="radio" name="Asthma0402" value="G9459">Currently a tobacco non-user. 
	...
	<input type="radio" name="Asthma0402" value="G9460">Tobacco assessment OR tobacco cessation intervention not performed, NOS. 
