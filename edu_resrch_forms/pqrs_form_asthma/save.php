...
$encounter = date("Ymd");
if ($_GET["mode"] == "new"){
$newid = formSubmit("pqrs_form_asthma", $_POST, $_GET["id"], $userauthorized);

addForm($encounter, "Asthma Checklist", $newid, "pqrs_form_asthma", $pid, $userauthorized);
}elseif ($_GET["mode"] == "update") {
sqlInsert("update pqrs_form_asthma set pid = {$_SESSION["pid"]},groupname='".$_SESSION["authProvider"]."',user='".$_SESSION["authUser"]."',authorized=$userauthorized,activity=1, date = NOW(),
purpose ='".$_POST["purpose"]."',
Asthma0053='".$_POST["Asthma0053"]."',
Asthma0110='".$_POST["Asthma0110"]."',
Asthma0128='".$_POST["Asthma0128"]."',
Asthma0130='".$_POST["Asthma0130"]."',
Asthma0226='".$_POST["Asthma0226"]."',
Asthma0402='".$_POST["Asthma0402"]."',
