...
<font size=2>
<form method=post action="<?php echo $rootdir;?>/forms/pqrs_form_hiv_aids/save.php?mode=new" name="my_form">
<br>
<span class="title"><center>HIV_AIDS Quality Reporting</center></span><br><br>
...
<textarea cols=120 rows=3 wrap=virtual name="purpose" >To ensure quality care and reporting on patients with HIV_AIDS.</textarea>
<br><br>
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="HIV_AIDS0047" value="1123F">Advanced care planning discussed and documented. 
	...
	<input type="radio" name="HIV_AIDS0047" value="1124F">Advanced care planning discussed and documented; patient did not wish or was not able to name a surrogate decision marker or provide an advance care plan, or patient’s cultural and/or spiritual beliefs preclude a discussion of advance care planning. 
	...
	<input type="radio" name="HIV_AIDS0047" value="1123F:8P">Advance care planning not documented, reason not otherwise specified. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="HIV_AIDS0134" value="G8431">Screening for clinical depression is documented as being positive AND a follow-up plan is documented. 
	...
	<input type="radio" name="HIV_AIDS0134" value="G8510">Screening for clinical depression is documented as negative, a follow-up plan is not required. 
	...
	<input type="radio" name="HIV_AIDS0134" value="G8433">Screening for clinical depression not documented, documentation stating the patient is not eligible. 
	...
	<input type="radio" name="HIV_AIDS0134" value="G8940">Screening for clinical depression documented as positive, a follow-up plan not documented, documentation stating the patient is not eligible 
	...
	<input type="radio" name="HIV_AIDS0134" value="G8432">Clinical depression screening not documented, reason not given. 
	...
	<input type="radio" name="HIV_AIDS0134" value="G8511">Screening for clinical depression documented as positive, follow-up plan not documented, reason not given. 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0160 <a target="_blank" href="#" title="(NQF #0405)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- HIV/AIDS: Pneumocystis Jiroveci Pneumonia (PCP) Prophylaxis <a target="_blank" href="#" title="National Quality Strategy Domain: Effective Clinical Care"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient prescribed pneumocystis jiroveci pneumonia (PCP) prophylaxis within 3 months of CD4 count below 200 cells/mm3? <a target="_blank" href="#" title="May include prescription given to the patient for PCP prophylaxis therapy at one or more visits in the 12-month period OR patient already taking PCP prophylaxis therapy as documented in current medication list."><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	<p></b>


	<input type="radio" name="HIV_AIDS0160" value="G9222 3494F">Pneumocystis jiroveci pneumonia prophylaxis prescribed within 3 months of low CD4+ cell count below 200 cells/mm3. AND CD4+ cell count &lt; 200 cells/mm3. 
	...
	<input type="radio" name="HIV_AIDS0160" value="3495F">CD4+ cell count 200 – 499 cells/mm3. 
	...
	<input type="radio" name="HIV_AIDS0160" value="3496F">CD4+ cell count = 500 cells/mm3. 
	...
	<input type="radio" name="HIV_AIDS0160" value="G9217 3494F">PCP prophylaxis was not prescribed within 3 months of low CD4+ cell count below 200 cells/mm3, reason not given. AND CD4+ cell count &lt; 200 cells/mm3. 
	...
	<input type="radio" name="HIV_AIDS0160" value="3494F:8P">CD4+ cell count not performed, reason not otherwise specified. 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0205 <a target="_blank" href="#" title="(NQF #0409)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- HIV/AIDS: Sexually Transmitted Disease Screening for Chlamydia, Gonorrhea, and Syphilis <a target="_blank" href="#" title="National Quality Strategy Domain: Effective Clinical Care"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient screened for chlamydia, gonorrhea, and syphilis at least once since the diagnosis of HIV infection? 
	<p></b>


	<input type="radio" name="HIV_AIDS0205" value="G9228">Chlamydia, gonorrhea, and syphilis screening results documented (report when results are present for all of the 3 screenings). 
	...
	<input type="radio" name="HIV_AIDS0205" value="G9229">Chlamydia, gonorrhea, and syphilis screening results not documented (Patient refusal is the only allowed exclusion). 
	...
	<input type="radio" name="HIV_AIDS0205" value="G9230">Chlamydia, gonorrhea, and syphilis screening not documented as performed, reason not otherwise specified. 
...
<tr>	<td> <br><p><br>
	...
	<p><b>
	Question: Was patient screened for tobacco use within 24 months AND given tobacco cessation interventionn//nif identified as a tobacco user? <a target="_blank" href="#" title="Tobacco Use – Includes use of any type of tobacco; Tobacco Cessation Intervention – Includes brief//n counseling (3 minutes or less), and/or pharmacotherapy."><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	<p></b>


	<input type="radio" name="HIV_AIDS0226" value="4004F">Patient Screened for Tobacco Use, Identified as a User and Received Intervention 
	...
	<input type="radio" name="HIV_AIDS0226" value="1036F">Patient Screened for Tobacco Use and Identified as a Non-User of Tobacco 
	...
	<input type="radio" name="HIV_AIDS0226" value="4004F:1P">Tobacco Screening not Performed for Medical Reasons 
	...
	<input type="radio" name="HIV_AIDS0226" value="4004F:8P">Tobacco Screening OR Tobacco Cessation Intervention not Performed, Reason Not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0338 <a target="_blank" href="#" title="(NQF #2082)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- HIV Viral Load Suppression <a target="_blank" href="#" title="National Quality Strategy Domain: Effective Clinical Care"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient's HIV viral load less than 200 copies/mL at last viral load test? 
	<p></b>


	<input type="radio" name="HIV_AIDS0338" value="G9243">Documentation of viral load less than 200 copies/mL. 
	...
	<input type="radio" name="HIV_AIDS0338" value="G9242">Documentation of viral load equal to or greater than 200 copies/mL or viral load not performed. 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0339 <a target="_blank" href="#" title="(NQF #2083)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- Prescription of HIV Antiretroviral Therapy <a target="_blank" href="#" title="National Quality Strategy Domain: Effective Clinical Care"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	Question: Was patient prescribed HIV antiretroviral therapy during the reporting period? <a target="_blank" href="#" title="HIV antiretroviral therapy is described as the prescription of at least one U.S. Food and Drug Administration approved HIV antiretroviral medication."><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	<p></b>


	<input type="radio" name="HIV_AIDS0339" value="G9245">Antiretroviral therapy prescribed. 
	...
	<input type="radio" name="HIV_AIDS0339" value="G9244">Antiretroviral therapy not prescribed. 
...
<tr>	<td> <br><p><br>
	<b>
	Measure #0340 <a target="_blank" href="#" title="(NQF #2079)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> -- HIV Medical Visit Frequency <a target="_blank" href="#" title="National Quality Strategy Domain: Efficiency And Cost Reduction"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 	</b>
	<p><b>
	...
	<input type="radio" name="HIV_AIDS0340" value="G9247">Patient had at least one medical visit in each 6 month period of the 24 month measurement period, with a minimum of 60 days between medical visits. 
	...
	<input type="radio" name="HIV_AIDS0340" value="G9246">Patient did not have at least one medical visit in each 6 month period of the 24 month measurement period, with a minimum of 60 days between medical visits. 
