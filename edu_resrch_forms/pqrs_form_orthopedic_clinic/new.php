...
formHeader("Form: Orthopedic Clinic");
?>
<html><head>
...
<font size=2>
<form method=post action="<?php echo $rootdir;?>/forms/pqrs_form_orthopedic_clinic/save.php?mode=new" name="my_form">
<br>
<span class="title"><center>Orthopedic Clinic Quality Reporting</center></span><br><br>
...
<textarea cols=120 rows=3 wrap=virtual name="purpose" >To ensure quality care and reporting on patients with Orthopedic Clinic.</textarea>
<br><br>
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0021" value="G9197">Documentation of Order for First or Second Generation Cephalosporin for Antimicrobial Prophylaxis (written order, verbal order, or standing order/protocol) 
	...
	<input type="radio" name="Orthopedic_Clinic0021" value="G9198">Order for first OR second generation cephalosporin for antimicrobial prophylaxis was not documented, reason not given. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0023" value="4044F">Documentation that an order was given for venous thromboembolism (VTE) prophylaxis to be given within 24 hours prior to incision time or 24 hours after surgery end time 
	...
	<input type="radio" name="Orthopedic_Clinic0023" value="4044F:1P">VTE Prophylaxis not Ordered for Medical Reasons 
	...
	<input type="radio" name="Orthopedic_Clinic0023" value="4044F:8P">VTE Prophylaxis not Ordered, Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0046" value="1111F">Documentation of Reconciliation of Discharge Medication with Current Medication List in the Medical Record 
	...
	<input type="radio" name="Orthopedic_Clinic0046" value="1111F:8P">Discharge Medication not Reconciled with Current Medication List in the Medical Record, Reason Not Otherwise Specified 
	...
	<input type="radio" name="Orthopedic_Clinic0046" value="NA0046">Patient was not discharged from an inpatient facility within the last 30 days. (There are no reporting requirements in this case. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0109" value="1006F">Osteoarthritis Symptoms and Functional Status Assessed (may include the use of a standardized scale or the completion of an assessment questionnaire, such as the SF-36, AAOS Hip & Knee Questionnaire) 
	...
	<input type="radio" name="Orthopedic_Clinic0109" value="1006F:8P">Osteoarthritis Symptoms and Functional Status not Assessed, Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0128" value="G8420">BMI is documented within normal parameters and no follow-up plan is required. 
	...
	<input type="radio" name="Orthopedic_Clinic0128" value="G8417">BMI is documented above normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="Orthopedic_Clinic0128" value="G8418">BMI is documented below normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="Orthopedic_Clinic0128" value="G8421">BMI not documented and no reason is given. 
	...
	<input type="radio" name="Orthopedic_Clinic0128" value="G8419">BMI documented outside normal parameters, no follow-up plan documented, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0154" value="3288F 1100F">Falls risk assessment documented and there is documentation of two or more falls in the past year or any fall with injury in the past year 
	...
	<input type="radio" name="Orthopedic_Clinic0154" value="3288F:1P 1100F">Medical reason(s) for not completing a risk assessment and there is documentation of two or more falls in the past year or any fall with injury in the past year 
	...
	<input type="radio" name="Orthopedic_Clinic0154" value="1101F">Patient screened for future fall risk; no falls or only one fall without injury in the past year. 
	...
	<input type="radio" name="Orthopedic_Clinic0154" value="1101F:8P">Patient not eligible; fall status not documented. 
	...
	<input type="radio" name="Orthopedic_Clinic0154" value="3288F:8P 1100F">Falls risk assessment not completed, AND there is documentation of two or more falls in the past year or any fall with injury in the past year. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0155" value="0518F">Falls plan of care documented. 
	...
	<input type="radio" name="Orthopedic_Clinic0155" value="0518F:1P">Documentation of medical reason(s) for no plan of care for falls. 
	...
	<input type="radio" name="Orthopedic_Clinic0155" value="0518F:8P">Plan of care not documented, reason NOS. 
	...
	<input type="radio" name="Orthopedic_Clinic0155" value="NA155">Measure does not apply to this patient. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0226" value="4004F">Patient screened for tobacco use AND received tobacco cessation intervention if identified as a tobacco user. 
	...
	<input type="radio" name="Orthopedic_Clinic0226" value="1036F">Current tobacco non-user. 
	...
	<input type="radio" name="Orthopedic_Clinic0226" value="4004F:1P">Documentation of medical reason(s) for not screening for tobacco use. 
	...
	<input type="radio" name="Orthopedic_Clinic0226" value="4004F:8P">Tobacco screening OR tobacco cessation intervention not performed, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0238" value="G9365">One high-risk medication ordered. 
	...
	<input type="radio" name="Orthopedic_Clinic0238" value="G9365 G9367">Two or more high-risk medications ordered 
	...
	<input type="radio" name="Orthopedic_Clinic0238" value="G9366 G9368">No orders for high risk medications. Does not apply to this patient. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="Orthopedic_Clinic0431" value="G9621">Patient identified as an unhealthy alcohol user when screened for unhealthy alcohol use using a systematic screening method and received brief counseling. 
	...
	<input type="radio" name="Orthopedic_Clinic0431" value="G9622">Patient not identified as an unhealthy alcohol user when screened for unhealthy alcohol use using a systematic screening method. 
	...
	<input type="radio" name="Orthopedic_Clinic0431" value="G9623">Documentation of medical reason(s) for not screening for unhealthy alcohol use (e.g., limited life expectancy, other medical reasons). 
	...
	<input type="radio" name="Orthopedic_Clinic0431" value="G9624">Patient not screened for unhealthy alcohol screening using a systematic screening method OR patient did not receive brief counseling, reason not given. 
