...
$obj = formFetch("pqrs_form_scrhio_orthopedics", $_GET["id"]);

?>
<form method=post action="<?php echo $rootdir?>/forms/pqrs_form_scrhio_orthopedics/save.php?mode=update&id=<?php echo $_GET["id"];?>" name="my_form">
<span class="title"><center><b>SCRHIO Orthopedics Quality Reporting</b></center></span><br><br>
<center>
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0021" value="G9197" <?php if ($obj{"SCRHIO_Orthopedics0021"} == "G9197") { echo 'checked=checked'; } ?> > Documentation of Order for First or Second Generation Cephalosporin for Antimicrobial Prophylaxis (written order, verbal order, or standing order/protocol) 
	...
	<input type="radio" name="SCRHIO_Orthopedics0021" value="G9198" <?php if ($obj{"SCRHIO_Orthopedics0021"} == "G9198") { echo 'checked=checked'; } ?> > Order for first OR second generation cephalosporin for antimicrobial prophylaxis was not documented, reason not given. 
...
<tr>	<td> <br><p><br>
	...
	<b>
	Measure #0022 
	 <a target="_blank" href="#" title="(NQF 0271)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	 -- Perioperative Care: Discontinuation of Prophylactic Parenteral Antibiotics (Non-Cardiac Procedures) Percentage of non-cardiac surgical patients aged 18 years and older undergoing procedures with the indications for prophylactic parenteral antibiotics AND who received a prophylactic parenteral antibiotic, who have an order for discontinuation of prophylactic parenteral antibiotics within 24 hours of surgical end time'), 
	 <a target="_blank" href="#" title="National Quality Strategy Domain: Patient Safety"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	</b>
	<p><b>
	...
	<input type="radio" name="SCRHIO_Orthopedics0022" value="4049F 4046F" <?php if ($obj{"SCRHIO_Orthopedics0022"} == "4049F 4046F") { echo 'checked=checked'; } ?> > Documentation of Order for Discontinuation of Prophylactic Parenteral Antibiotics Within 24 Hours of Surgical End Time. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0022" value="4049F:1P 4046F" <?php if ($obj{"SCRHIO_Orthopedics0022"} == "4049F:1P 4046F") { echo 'checked=checked'; } ?> > Prophylactic Parenteral Antibiotics not Discontinued for Medical Reasons 
	...
	<input type="radio" name="SCRHIO_Orthopedics0022" value="4042F" <?php if ($obj{"SCRHIO_Orthopedics0022"} == "4042F") { echo 'checked=checked'; } ?> > Patient not eligible for this measure because patient did not receive prophylactic parenteral antibiotics within specified timeframe 
	...
	<input type="radio" name="SCRHIO_Orthopedics0022" value="4049F:8P 4046F" <?php if ($obj{"SCRHIO_Orthopedics0022"} == "4049F:8P 4046F") { echo 'checked=checked'; } ?> > Prophylactic Parenteral Antibiotics not Discontinued, Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0023" value="4044F" <?php if ($obj{"SCRHIO_Orthopedics0023"} == "4044F") { echo 'checked=checked'; } ?> > Documentation that an order was given for venous thromboembolism (VTE) prophylaxis to be given within 24 hours prior to incision time or 24 hours after surgery end time 
	...
	<input type="radio" name="SCRHIO_Orthopedics0023" value="4044F:1P" <?php if ($obj{"SCRHIO_Orthopedics0023"} == "4044F:1P") { echo 'checked=checked'; } ?> > VTE Prophylaxis not Ordered for Medical Reasons 
	...
	<input type="radio" name="SCRHIO_Orthopedics0023" value="4044F:8P" <?php if ($obj{"SCRHIO_Orthopedics0023"} == "4044F:8P") { echo 'checked=checked'; } ?> > VTE Prophylaxis not Ordered, Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0039" value="G8399" <?php if ($obj{"SCRHIO_Orthopedics0039"} == "G8399") { echo 'checked=checked'; } ?> > Patient record includes documented results of a central Dual-energy X-Ray Absorptiometry (DXA). 
	...
	<input type="radio" name="SCRHIO_Orthopedics0039" value="G8401" <?php if ($obj{"SCRHIO_Orthopedics0039"} == "G8401") { echo 'checked=checked'; } ?> > Clinician documented that patient was not an eligible candidate for screening. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0039" value="G8400" <?php if ($obj{"SCRHIO_Orthopedics0039"} == "G8400") { echo 'checked=checked'; } ?> > Patient with central DXA results not documented, reason not given. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0046" value="1111F" <?php if ($obj{"SCRHIO_Orthopedics0046"} == "1111F") { echo 'checked=checked'; } ?> > Documentation of Reconciliation of Discharge Medication with Current Medication List in the Medical Record 
	...
	<input type="radio" name="SCRHIO_Orthopedics0046" value="1111F:8P" <?php if ($obj{"SCRHIO_Orthopedics0046"} == "1111F:8P") { echo 'checked=checked'; } ?> > Discharge Medication not Reconciled with Current Medication List in the Medical Record, Reason Not Otherwise Specified 
	...
	<input type="radio" name="SCRHIO_Orthopedics0046" value="NA0046" <?php if ($obj{"SCRHIO_Orthopedics0046"} == "NA0046") { echo 'checked=checked'; } ?> > Patient was not discharged from an inpatient facility within the last 30 days. (There are no reporting requirements in this case. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0109" value="1006F:8P" <?php if ($obj{"SCRHIO_Orthopedics0109"} == "1006F:8P") { echo 'checked=checked'; } ?> > Osteoarthritis Symptoms and Functional Status not Assessed, Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	Measure #0110 
	 ...
	 <a target="_blank" href="#" title="Quality Strategy Domain: Community/Population Health"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a> 
	</b>
	<p><b>
	...
	<input type="radio" name="SCRHIO_Orthopedics0110" value="G8482" <?php if ($obj{"SCRHIO_Orthopedics0110"} == "G8482") { echo 'checked=checked'; } ?> > Influenza Immunization Administered 
	...
	<input type="radio" name="SCRHIO_Orthopedics0110" value="G8482" <?php if ($obj{"SCRHIO_Orthopedics0110"} == "G8482") { echo 'checked=checked'; } ?> > Influenza Immunization previously received 
	 <a target="_blank" href="#" title="(G8482) (Performance Met)"><img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Tango-style_question_icon.svg" height="13px"/></a>	<br>


	<input type="radio" name="SCRHIO_Orthopedics0110" value="G8483" <?php if ($obj{"SCRHIO_Orthopedics0110"} == "G8483") { echo 'checked=checked'; } ?> > Influenza Immunization not Administered for Documented Reasons (e.g., patient allergy or other medical reasons, patient declined or other patient reasons, vaccine not available or other system reasons) 
	...
	<input type="radio" name="SCRHIO_Orthopedics0110" value="G8484" <?php if ($obj{"SCRHIO_Orthopedics0110"} == "G8484") { echo 'checked=checked'; } ?> > Influenza Immunization not Administered, Reason not Given 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0111" value="4040F" <?php if ($obj{"SCRHIO_Orthopedics0111"} == "4040F") { echo 'checked=checked'; } ?> > Pneumococcal Vaccination Administered or Previously Received 
	...
	<input type="radio" name="SCRHIO_Orthopedics0111" value="4040:8P" <?php if ($obj{"SCRHIO_Orthopedics0111"} == "4040:8P") { echo 'checked=checked'; } ?> > Pneumococcal Vaccination not Administered or Previously Received,Reason not Otherwise Specified 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0128" value="G8420" <?php if ($obj{"SCRHIO_Orthopedics0128"} == "G8420") { echo 'checked=checked'; } ?> > BMI is documented within normal parameters and no follow-up plan is required. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0128" value="G8417" <?php if ($obj{"SCRHIO_Orthopedics0128"} == "G8417") { echo 'checked=checked'; } ?> > BMI is documented above normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0128" value="G8418" <?php if ($obj{"SCRHIO_Orthopedics0128"} == "G8418") { echo 'checked=checked'; } ?> > BMI is documented below normal parameters and a follow-up plan is documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0128" value="G8421" <?php if ($obj{"SCRHIO_Orthopedics0128"} == "G8421") { echo 'checked=checked'; } ?> > BMI not documented and no reason is given. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0128" value="G8419" <?php if ($obj{"SCRHIO_Orthopedics0128"} == "G8419") { echo 'checked=checked'; } ?> > BMI documented outside normal parameters, no follow-up plan documented, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<p><b>
	Question: Are current medications documented in the patient's medical record at EACH patient visit during the reporting year? 
	...
	<input type="radio" name="SCRHIO_Orthopedics0130" value="G8427" <?php if ($obj{"SCRHIO_Orthopedics0130"} == "G8427") { echo 'checked=checked'; } ?> > Current (or no) medications documented in the patient's medical record. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0130" value="G8430" <?php if ($obj{"SCRHIO_Orthopedics0130"} == "G8430") { echo 'checked=checked'; } ?> > Patient is not eligible. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0130" value="G8428" <?php if ($obj{"SCRHIO_Orthopedics0130"} == "G8428") { echo 'checked=checked'; } ?> > Current list of medications not documented, reason not given. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8730" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8730") { echo 'checked=checked'; } ?> > Pain assessment documented as positive AND a follow-up plan is documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8731" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8731") { echo 'checked=checked'; } ?> > Pain assessment is documented as negative, no follow-up plan required. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8442" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8442") { echo 'checked=checked'; } ?> > Patient is not eligible for a pain assessment. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8939" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8939") { echo 'checked=checked'; } ?> > Pain assessment documented as positive, no follow-up plan, patient is not eligible. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8732" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8732") { echo 'checked=checked'; } ?> > No documentation of pain assessment, reason not given. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0131" value="G8509" <?php if ($obj{"SCRHIO_Orthopedics0131"} == "G8509") { echo 'checked=checked'; } ?> > Pain assessment documented as positive, no follow-up plan is documented. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0154" value="3288F 1100F" <?php if ($obj{"SCRHIO_Orthopedics0154"} == "3288F 1100F") { echo 'checked=checked'; } ?> > Falls risk assessment documented and there is documentation of two or more falls in the past year or any fall with injury in the past year 
	...
	<input type="radio" name="SCRHIO_Orthopedics0154" value="3288F:1P 1100F" <?php if ($obj{"SCRHIO_Orthopedics0154"} == "3288F:1P 1100F") { echo 'checked=checked'; } ?> > Medical reason(s) for not completing a risk assessment and there is documentation of two or more falls in the past year or any fall with injury in the past year 
	...
	<input type="radio" name="SCRHIO_Orthopedics0154" value="1101F" <?php if ($obj{"SCRHIO_Orthopedics0154"} == "1101F") { echo 'checked=checked'; } ?> > Patient screened for future fall risk; no falls or only one fall without injury in the past year. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0154" value="1101F:8P" <?php if ($obj{"SCRHIO_Orthopedics0154"} == "1101F:8P") { echo 'checked=checked'; } ?> > Patient not eligible; fall status not documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0154" value="3288F:8P 1100F" <?php if ($obj{"SCRHIO_Orthopedics0154"} == "3288F:8P 1100F") { echo 'checked=checked'; } ?> > Falls risk assessment not completed, AND there is documentation of two or more falls in the past year or any fall with injury in the past year. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0155" value="0518F" <?php if ($obj{"SCRHIO_Orthopedics0155"} == "0518F") { echo 'checked=checked'; } ?> > Falls plan of care documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0155" value="0518F:1P" <?php if ($obj{"SCRHIO_Orthopedics0155"} == "0518F:1P") { echo 'checked=checked'; } ?> > Documentation of medical reason(s) for no plan of care for falls. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0155" value="0518F:8P" <?php if ($obj{"SCRHIO_Orthopedics0155"} == "0518F:8P") { echo 'checked=checked'; } ?> > Plan of care not documented, reason NOS. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0155" value="NA155" <?php if ($obj{"SCRHIO_Orthopedics0155"} == "NA155") { echo 'checked=checked'; } ?> > Measure does not apply to this patient. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0226" value="4004F" <?php if ($obj{"SCRHIO_Orthopedics0226"} == "4004F") { echo 'checked=checked'; } ?> > Patient screened for tobacco use AND received tobacco cessation intervention if identified as a tobacco user. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0226" value="1036F" <?php if ($obj{"SCRHIO_Orthopedics0226"} == "1036F") { echo 'checked=checked'; } ?> > Current tobacco non-user. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0226" value="4004F:1P" <?php if ($obj{"SCRHIO_Orthopedics0226"} == "4004F:1P") { echo 'checked=checked'; } ?> > Documentation of medical reason(s) for not screening for tobacco use. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0226" value="4004F:8P" <?php if ($obj{"SCRHIO_Orthopedics0226"} == "4004F:8P") { echo 'checked=checked'; } ?> > Tobacco screening OR tobacco cessation intervention not performed, NOS. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0238" value="G9365" <?php if ($obj{"SCRHIO_Orthopedics0238"} == "G9365") { echo 'checked=checked'; } ?> > One high-risk medication ordered. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0238" value="G9365 G9367" <?php if ($obj{"SCRHIO_Orthopedics0238"} == "G9365 G9367") { echo 'checked=checked'; } ?> > Two or more high-risk medications ordered 
	...
	<input type="radio" name="SCRHIO_Orthopedics0238" value="G9366 G9368" <?php if ($obj{"SCRHIO_Orthopedics0238"} == "G9366 G9368") { echo 'checked=checked'; } ?> > No orders for high risk medications. Does not apply to this patient. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0317" value="G8783" <?php if ($obj{"SCRHIO_Orthopedics0317"} == "G8783") { echo 'checked=checked'; } ?> > Normal blood pressure reading documented, follow-up not required. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0317" value="G8950" <?php if ($obj{"SCRHIO_Orthopedics0317"} == "G8950") { echo 'checked=checked'; } ?> > Pre-Hypertensive or Hypertensive blood pressure reading documented, AND the indicated follow-up is documented. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0317" value="G8784" <?php if ($obj{"SCRHIO_Orthopedics0317"} == "G8784") { echo 'checked=checked'; } ?> > Patient not eligible. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0317" value="G8785" <?php if ($obj{"SCRHIO_Orthopedics0317"} == "G8785") { echo 'checked=checked'; } ?> > Blood pressure reading not documented, reason not specified. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0317" value="G8952" <?php if ($obj{"SCRHIO_Orthopedics0317"} == "G8952") { echo 'checked=checked'; } ?> > Pre-Hypertensive or Hypertensive blood pressure reading documented, indicated follow-up not documented, reason not specified. 
...
<tr>	<td> <br><p><br>
	...
	<input type="radio" name="SCRHIO_Orthopedics0431" value="G9621" <?php if ($obj{"SCRHIO_Orthopedics0431"} == "G9621") { echo 'checked=checked'; } ?> > Patient identified as an unhealthy alcohol user when screened for unhealthy alcohol use using a systematic screening method and received brief counseling. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0431" value="G9622" <?php if ($obj{"SCRHIO_Orthopedics0431"} == "G9622") { echo 'checked=checked'; } ?> > Patient not identified as an unhealthy alcohol user when screened for unhealthy alcohol use using a systematic screening method. 
	...
	<input type="radio" name="SCRHIO_Orthopedics0431" value="G9623" <?php if ($obj{"SCRHIO_Orthopedics0431"} == "G9623") { echo 'checked=checked'; } ?> > Documentation of medical reason(s) for not screening for unhealthy alcohol use (e.g., limited life expectancy, other medical reasons). 
	...
	<input type="radio" name="SCRHIO_Orthopedics0431" value="G9624" <?php if ($obj{"SCRHIO_Orthopedics0431"} == "G9624") { echo 'checked=checked'; } ?> > Patient not screened for unhealthy alcohol screening using a systematic screening method OR patient did not receive brief counseling, reason not given. 
